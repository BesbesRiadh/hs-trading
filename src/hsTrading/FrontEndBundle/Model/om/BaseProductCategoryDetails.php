...
abstract class BaseProductCategoryDetails extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'hsTrading\\FrontEndBundle\\Model\\ProductCategoryDetailsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProductCategoryDetailsPeer
     */
    ...
    /**
     * The value for the productcategory_id field.
     * @var        int
     */
    protected $productcategory_id;
    ...
    /**
     * The value for the labeleng field.
     * @var        string
     */
    protected $labeleng;
    ...
    /**
     * Get the [productcategory_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [labeleng] column value.
     *
     * @return string
     */
    public function getLabeleng()
    {
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ProductCategoryDetailsPeer::ID;
        }
    ...
    /**
     * Set the value of [productcategory_id] column.
     *
     * @param  int $v new value
     * @return ProductCategoryDetails The current object (for fluent API support)
     */
    public function setProductcategoryId($v)
    {
        ...
        if ($this->productcategory_id !== $v) {
            $this->productcategory_id = $v;
            $this->modifiedColumns[] = ProductCategoryDetailsPeer::PRODUCTCATEGORY_ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = ProductCategoryDetailsPeer::CODE;
        }
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[] = ProductCategoryDetailsPeer::LABEL;
        }
    ...
    /**
     * Set the value of [labeleng] column.
     *
     * @param  string $v new value
     * @return ProductCategoryDetails The current object (for fluent API support)
     */
    public function setLabeleng($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->labeleng !== $v) {
            $this->labeleng = $v;
            $this->modifiedColumns[] = ProductCategoryDetailsPeer::LABELENG;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProductCategoryDetailsPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProductCategoryDetailsPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->labeleng = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->categorder = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            ...
            return $startcol + 8; // 8 = ProductCategoryDetailsPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aProductCategory !== null && $this->productcategory_id !== $this->aProductCategory->getId()) {
            $this->aProductCategory = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProductCategoryDetailsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProductCategoryDetailsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProductCategoryDetailsPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProductCategoryDetailsPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ProductCategoryDetailsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductCategoryDetailsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ProductCategoryDetailsPeer::PRODUCTCATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`productCategory_id`';
        }
        if ($this->isColumnModified(ProductCategoryDetailsPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(ProductCategoryDetailsPeer::LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`label`';
        }
        if ($this->isColumnModified(ProductCategoryDetailsPeer::LABELENG)) {
            $modifiedColumns[':p' . $index++]  = '`labeleng`';
        }
        ...
        $sql = sprintf(
            'INSERT INTO `hs_product_category_details` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`productCategory_id`':
                        $stmt->bindValue($identifier, $this->productcategory_id, PDO::PARAM_INT);
                        break;
                    case '`code`':
                    ...
                    case '`label`':
                        ...
                        break;
                    case '`labeleng`':
                        $stmt->bindValue($identifier, $this->labeleng, PDO::PARAM_STR);
                        break;
                    case '`categorder`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProductCategoryDetailsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProductCategoryDetailsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProductCategoryDetails'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductCategoryDetails'][$this->getPrimaryKey()] = true;
        $keys = ProductCategoryDetailsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProductcategoryId(),
            $keys[2] => $this->getCode(),
            $keys[3] => $this->getLabel(),
            $keys[4] => $this->getLabeleng(),
            $keys[5] => $this->getCategorder(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setLabeleng($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setCategorder($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductCategoryDetailsPeer::ID)) $criteria->add(ProductCategoryDetailsPeer::ID, $this->id);
        ...
        if ($this->isColumnModified(ProductCategoryDetailsPeer::LABELENG)) $criteria->add(ProductCategoryDetailsPeer::LABELENG, $this->labeleng);
    ...
    {
        $criteria = new Criteria(ProductCategoryDetailsPeer::DATABASE_NAME);
        $criteria->add(ProductCategoryDetailsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProductCategoryDetails (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLabeleng($this->getLabeleng());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProductCategoryDetails Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProductCategoryDetailsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProductCategoryDetailsPeer();
        }
    ...
    public function setProductCategory(ProductCategory $v = null)
    {
        ...
        if ($v !== null) {
            $v->addProductCategoryDetails($this);
        }
    ...
    {
        if ($this->aProductCategory === null && ($this->productcategory_id !== null) && $doQuery) {
            $this->aProductCategory = ProductCategoryQuery::create()->findPk($this->productcategory_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProductCategory->addProductCategoryDetailss($this);
             */
        }
     ...
     * If this ProductCategoryDetails is new, it will return
        ...
        if (null === $this->collProducts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collProducts) {
                ...
                $collProducts = ProductQuery::create(null, $criteria)
                    ->filterByProductCategoryDetails($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setProducts(PropelCollection $products, PropelPDO $con = null)
    {
        ...
        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setProductCategoryDetails(null);
        }
    ...
    protected function doAddProduct($product)
    {
        ...
        $product->setProductCategoryDetails($this);
    }
    ...
    public function removeProduct($product)
    {
        if ($this->getProducts()->contains($product)) {
            ...
            $product->setProductCategoryDetails(null);
        }
     ...
     * Otherwise if this ProductCategoryDetails is new, it will return
     * an empty collection; or if this ProductCategoryDetails has previously
     * been saved, it will retrieve related Products from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProductCategoryDetails.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProductCategoryDetailsPeer::DEFAULT_STRING_FORMAT);
    }
