...
abstract class BaseProduct extends BaseObject implements Persistent
{
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ProductPeer::UPDATED_BY;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductPeer::UPDATED_BY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductPeer::UPDATED_BY)) $criteria->add(ProductPeer::UPDATED_BY, $this->updated_by);
