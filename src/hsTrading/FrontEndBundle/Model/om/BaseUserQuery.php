...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'hsTrading\\FrontEndBundle\\Model\\User';
        }
    ...
    {
        $sql = 'SELECT `id`, `firstname`, `lastname`, `mail`, `password`, `active`, `roles`, `updated_by`, `created_at`, `updated_at` FROM `hs_user` WHERE `id` = :p0';
        try {
