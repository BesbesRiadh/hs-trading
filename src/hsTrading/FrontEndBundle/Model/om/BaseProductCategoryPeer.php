...
use hsTrading\FrontEndBundle\Model\map\ProductCategoryTableMap;
...
abstract class BaseProductCategoryPeer
{
    ...
    const TABLE_NAME = 'hs_product_category';

    /** the related Propel class for this table */
    const OM_CLASS = 'hsTrading\\FrontEndBundle\\Model\\ProductCategory';

    /** the related TableMap class for this table */
    const TM_CLASS = 'hsTrading\\FrontEndBundle\\Model\\map\\ProductCategoryTableMap';
    ...
    const ID = 'hs_product_category.id';

    /** the column name for the code field */
    const CODE = 'hs_product_category.code';

    /** the column name for the label field */
    const LABEL = 'hs_product_category.label';

    /** the column name for the created_at field */
    const CREATED_AT = 'hs_product_category.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'hs_product_category.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Label', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'label', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (ProductCategoryPeer::ID, ProductCategoryPeer::CODE, ProductCategoryPeer::LABEL, ProductCategoryPeer::CREATED_AT, ProductCategoryPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'LABEL', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'label', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Label' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'label' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (ProductCategoryPeer::ID => 0, ProductCategoryPeer::CODE => 1, ProductCategoryPeer::LABEL => 2, ProductCategoryPeer::CREATED_AT => 3, ProductCategoryPeer::UPDATED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'LABEL' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'label' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductCategoryPeer::CODE);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to hs_product_category
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductCategoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \hsTrading\FrontEndBundle\Model\map\ProductCategoryTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the hs_product_category table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
