...
abstract class BaseTest extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'hsTrading\\FrontEndBundle\\Model\\TestPeer';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = TestPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TestPeer::NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `hs_Test` (%s) VALUES (%s)',
