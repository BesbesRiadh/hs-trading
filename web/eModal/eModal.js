    ...
    define(['jquery'], function ($) {
        ...
        function prompt(data, title, callback) {
            ...
            var buttons = getFooter([
                { close: true, type: 'reset', text: 'Annuler', style: 'danger' },
        ...
        function getDefaultSettings() {
            return {
                ...
                size: '',
                loadingHtml: '<span class="fa fa-spinner fa-spin fa-3x text-primary" style="position: absolute; left: 50%;" align="center">',
                title: 'Attention'
            };
        }
        function getModalInstance() {
            ...
            function createModalElement() {
                ...
                return $('<div class="modal fade col-xs-11 col-md-12" tabindex="-1">'
                + ' <div class=modal-dialog>'
                + '  <div class=modal-content>'
                + '   <div class=modal-header><button type=button class="x close" data-dismiss=modal><span aria-hidden=true>&times;</span><span class=sr-only>Fermer</span></button><h4 class=modal-title></h4></div>'
                + '  </div>'
                + ' </div>'
                + '</div>')
        ...
        function getFooter(buttons) {
            ...
            if (buttons) {
                ...
                messageFotter.append('<button class="x btn btn-info" data-dismiss=modal type=button>Fermer</button>');
            }
